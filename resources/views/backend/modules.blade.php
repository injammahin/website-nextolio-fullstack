        ...
        <div class="p-3">
            <div class="card">
                <div class="card-header bg-job text-gray d-flex justify-content-between align-items-center">
                    ...
                    <a href="{{ route('backend.new_products.index') }}" class="btn btn-sm btn-primary ml-2 ">Back to New
                        Products</a>
                    <a href="{{ route('backend.modules.create') }}" class="btn btn-sm btn-success ml-auto">
