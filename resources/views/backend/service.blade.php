        ...
        <div class="pt-5 px-5">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="row mb-3">
                        <div class="col-md-6">
                            <form action="{{ route('backend.service') }}" method="GET" class="form-inline">
                        ...
                        <!-- Search Bar -->
                        <div class="col-md-6">
                            <form action="{{ route('backend.service') }}" method="GET"
                            ...
                            <tbody>
                                @forelse ($services as $index=> $service)
                                    <tr>
                                        ...
                                        <td>
                                            <!-- View Button -->
                                            <a href="{{ route('frontend.services.details', $service->slug) }}"
